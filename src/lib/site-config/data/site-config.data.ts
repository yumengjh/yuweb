...
export const siteConfig = {
  ...
  homePage: {
    ...
    capabilities: [
      { icon: "arch", title: home.capability.arch.title, eyebrow: home.capability.arch.eyebrow, desc: home.capability.arch.desc },
      { icon: "logic", title: home.capability.logic.title, eyebrow: home.capability.logic.eyebrow, desc: home.capability.logic.desc },
      { icon: "server", title: home.capability.server.title, eyebrow: home.capability.server.eyebrow, desc: home.capability.server.desc },
      { icon: "optimize", title: home.capability.optimize.title, eyebrow: home.capability.optimize.eyebrow, desc: home.capability.optimize.desc },
    ] as const,
    works: [
      { year: "2024", visual: "light", align: "left", title: home.work.matrix.title, type: home.work.matrix.type },
      { year: "2023", visual: "dark", align: "right", title: home.work.grid.title, type: home.work.grid.type },
    ] as const,
    gears: [
      { category: "COMPUTE", name: "MacBook Pro 16", spec: "M3 Max / 64GB / 2TB", desc: home.gear.compute.desc },
      { category: "DISPLAY", name: "Apple Studio Display", spec: "5K Retina / Nano-texture", desc: home.gear.display.desc },
      { category: "INPUT", name: "HHKB Pro HYBRID", spec: "Topre Switches / Type-S", desc: home.gear.input.desc },
      { category: "SUPPORT", name: "Herman Miller Aeron", spec: "Size B / PostureFit SL", desc: home.gear.support.desc },
    ] as const,
    books: [
      { id: "B-01", title: "Grid Systems in Graphic Design", author: "Josef Müller-Brockmann", year: "1981" },
    ...
    experiences: [
      { period: home.experience.lead.period, title: home.experience.lead.title, company: home.experience.lead.company },
      { period: home.experience.senior.period, title: home.experience.senior.title, company: home.experience.senior.company },
      { period: home.experience.visual.period, title: home.experience.visual.title, company: home.experience.visual.company },
    ] as const,
  },
  notFoundPage: {
